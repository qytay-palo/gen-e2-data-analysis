...
applyTo: 'data/1_raw/**, data/2_external/**, src/data_processing/*loader*.py, src/data_processing/*connector*.py, src/data_processing/*extractor*.py, scripts/extract*.py, notebooks/1_exploratory/*extract*.ipynb, **/notebooks/1_exploratory/*load*.ipynb, sql/extractions/**, docs/objectives/user_stories/**/*extract*.md, src/problem_statement-**/notebooks/**clean**.ipynb, **/notebooks/**clean**.ipynb'
---
