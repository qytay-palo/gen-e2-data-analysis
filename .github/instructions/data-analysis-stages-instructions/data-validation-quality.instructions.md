...
applyTo: 'src/data_processing/*validator*.py, src/data_processing/*quality*.py, src/data_processing/*profiler*.py, data/3_interim/**, logs/etl/**, tests/data/**, notebooks/1_exploratory/*profile*.ipynb, notebooks/1_exploratory/*quality*.ipynb, docs/objectives/user_stories/**/*validate*.md, src/problem_statement-**/notebooks/**profile**.ipynb, src/problem_statement-**/notebooks/**quality**.ipynb'
---
