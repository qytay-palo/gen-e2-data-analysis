...
applyTo: 'notebooks/1_exploratory/**, notebooks/2_analysis/*exploratory*.ipynb, src/analysis/*eda*.py, reports/figures/exploratory/**, docs/objectives/user_stories/**/*analyz*.md, docs/objectives/user_stories/**/*exploratory*.md, docs/objectives/user_stories/**/*quantif*.md, src/problem_statement-**/notebooks/**exploratory**.ipynb, **/notebooks/**exploratory**.ipynb'
---
