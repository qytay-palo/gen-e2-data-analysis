...
applyTo: 'src/models/**, notebooks/2_analysis/*model*.ipynb, notebooks/2_analysis/*forecast*.ipynb, models/**, results/metrics/**, docs/objectives/user_stories/**/*forecast*.md, docs/objectives/user_stories/**/*forecast*.md, docs/objectives/user_stories/**/*generate*.md, src/problem_statement-**/notebooks/**forecas**.ipynb, **/notebooks/**forecas**.ipynb, src/problem_statement-**/notebooks/**model**.ipynb, **/notebooks/**model**.ipynb'
---
