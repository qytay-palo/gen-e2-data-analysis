...
**Handoff Protocol**:
- Output to `shared/data/3_interim/agent_handoffs/{agent}_{timestamp}.json`
...
- Execute: `python shared/src/orchestration/pipeline_orchestrator.py --problem-statement ps-{num}-{name}`
- Monitor: `problem-statement/ps-{num}-{name}/logs/pipeline_{timestamp}.log`
